...
(
    CATID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE AuthenEmail
(
    AuthenID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY,
    Authen_Code VARCHAR(128) NOT NULL,
    teacher_ID BIGINT NOT NULL,
